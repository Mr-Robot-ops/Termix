...
export const TERMINAL_AUTOCOMPLETE_HELP = [
  ...
  },
  {
    ...
    category: "system",
    risk: "safe",
    examples: ["lspci", "lspci -nn", "lspci -k", "lspci -vv"],
    options: ["-v", "-vv", "-k", "-nn", "-s <slot>", "-d <vendor:device>", "-t"],
  },
  {
    command: "lsusb",
    ...
    category: "system",
    risk: "safe",
    examples: ["lsusb", "lsusb -t", "lsusb -v", "lsusb -d 1d6b:"],
    options: ["-t", "-v", "-d <vendor:product>", "-s <bus:device>", "-D <device>"],
  },
  {
    command: "lsmod",
